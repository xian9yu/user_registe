...
func sendMail(code string, sjr string) {
	m := gomail.NewMessage()
	m.SetAddressHeader("From", "etinifninfinite@126.com", "注册验证邮件") // 发件人
	...
	d := gomail.NewDialer("smtp.126.com", 465, "etinifninfinite@126.com", "HHCZQTJPTQUMBDXC") // 发送邮件服务器、端口、发件人账号、发件人密码
